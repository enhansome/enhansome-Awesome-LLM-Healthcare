...
* \[2023/06] **MedicalGPT: Training Medical GPT Model** *Ming Xu et al.* \[[code](https://github.com/shibing624/MedicalGPT) ⭐ 5,731 | 🐛 6 | 🌐 Python | 📅 2026-06-03]
...
* \[2023/11] **MEDITRON-70B: Scaling Medical Pretraining for Large Language Models** *Zeming Chen et al. arXiv.* \[[paper](https://arxiv.org/abs/2311.16079)]\[[code](https://github.com/epfLLM/meditron) ⭐ 2,206 | 🐛 17 | 🌐 Python | 📅 2024-04-10]
...
* \[2023/07] **MING: A Chinese Medical Consultation Large Model** *Yusheng Liao et al.* \[[code](https://github.com/MediaBrain-SJTU/MING) ⭐ 1,173 | 🐛 23 | 🌐 Python | 📅 2025-05-23]
...
* \[2023/06] **TCMLLM** *Xuezhong Zhou et al.* \[[code](https://github.com/2020MEAI/TCMLLM) ⭐ 262 | 🐛 9 | 🌐 Python | 📅 2025-05-27]
...
* \[2022/12] **A large language model for electronic health records** *Xi Yang et al. npj Digital Medicine.* \[[paper](https://www.nature.com/articles/s41746-022-00742-2)] \[[code](https://github.com/uf-hobi-informatics-lab/GatorTron) ⭐ 139 | 🐛 5 | 🌐 Python | 📅 2023-11-03]
...
* \[2023/06] **LLaVA-Med: Training a Large Language-and-Vision Assistant for Biomedicine in One Day** *Chunyuan Li et al. arXiv.* \[[paper](https://arxiv.org/abs/2306.00890)] \[[code](https://github.com/microsoft/LLaVA-Med/blob/main/README.md) ⭐ 2,229 | 🐛 107 | 🌐 Python | 📅 2025-06-04]
...
* \[2023/04] **Visual Med-Alpaca: A Parameter-Efficient Biomedical LLM with Visual Capabilities** *Chang Shu et al.* \[[blog](https://cambridgeltl.github.io/visual-med-alpaca/)] \[[code](https://github.com/cambridgeltl/visual-med-alpaca) ⭐ 393 | 🐛 9 | 🌐 Python | 📅 2024-03-11]
...
* \[2023/06] **A Survey on Multimodal Large Language Models.** *Shukang Yin et al. arXiv.* \[[paper](https://arxiv.org/abs/2306.13549)] \[[code](https://github.com/BradyFU/Awesome-Multimodal-Large-Language-Models) ⭐ 17,984 | 🐛 111 | 📅 2026-08-14]
...
* \[2023/07] **Aligning Large Language Models with Human: A Survey.** *Yufei Wang et al. arXiv.* \[[paper](https://arxiv.org/abs/2307.12966)] \[[code](https://github.com/GaryYufei/AlignLLMHumanSurvey) ⭐ 741 | 🐛 0 | 📅 2023-09-11]
...
* [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,274 | 🐛 438 | 📅 2025-07-31
