...
* \[2023/06] **MedicalGPT: Training Medical GPT Model** *Ming Xu et al.* \[[code](https://github.com/shibing624/MedicalGPT) ⭐ 5,764 | 🐛 6 | 🌐 Python | 📅 2026-06-03]
...
* \[2023/05] **HuatuoGPT, towards Taming Language Model to Be a Doctor** *Hongbo Zhang et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.15075)] \[[code](https://github.com/FreedomIntelligence/HuatuoGPT) ⭐ 1,325 | 🐛 3 | 🌐 Python | 📅 2024-12-16]
...
* \[2023/04] **BianQue: Balancing the Questioning and Suggestion Ability of Health LLMs with Multi-turn Health Conversations Polished by ChatGPT** *Yirong Chen et al. arXiv.* \[[paper](https://arxiv.org/abs/2310.15896)] \[[code](https://github.com/scutcyr/BianQue) ⭐ 888 | 🐛 22 | 🌐 Python | 📅 2023-10-25]
...
* \[2023/06] **Sunsimiao: Chinese Medicine LLM** *Xin Yan et al.* \[[code](https://github.com/thomas-yanxin/Sunsimiao) ⭐ 469 | 🐛 6 | 🌐 Python | 📅 2024-09-13]
...
* \[2023/05] **XrayGLM: The first Chinese Medical Multimodal Model that Chest Radiographs Summarization** *Rongsheng Wang et al.* \[[code](https://github.com/WangRongsheng/XrayGLM) ⭐ 1,083 | 🐛 28 | 🌐 Python | 📅 2024-11-20]
...
* [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,307 | 🐛 444 | 📅 2025-07-31
* [Awesome-Chinese-LLM](https://github.com/HqWu-HITCS/Awesome-Chinese-LLM) ⭐ 22,749 | 🐛 29 | 📅 2026-05-10
