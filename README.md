# Awesome Large Language Models Illuminate a Progressive Pathway to Artificial Healthcare Assistant: A Review with stars
...
* \[2023/06] **MedicalGPT: Training Medical GPT Model** *Ming Xu et al.* \[[code](https://github.com/shibing624/MedicalGPT) ⭐ 5,715 | 🐛 6 | 🌐 Python | 📅 2026-06-03]
* \[2023/04] **HuaTuo: Tuning LLaMA Model with Chinese Medical Knowledge** *Haochun Wang et al. arXiv.* \[[paper](https://arxiv.org/abs/2304.06975)] \[[code](https://github.com/SCIR-HI/Huatuo-Llama-Med-Chinese) ⭐ 4,984 | 🐛 28 | 🌐 Python | 📅 2026-07-04]
...
* \[2023/11] **MEDITRON-70B: Scaling Medical Pretraining for Large Language Models** *Zeming Chen et al. arXiv.* \[[paper](https://arxiv.org/abs/2311.16079)]\[[code](https://github.com/epfLLM/meditron) ⭐ 2,204 | 🐛 17 | 🌐 Python | 📅 2024-04-10]
* \[2023/05] **HuatuoGPT, towards Taming Language Model to Be a Doctor** *Hongbo Zhang et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.15075)] \[[code](https://github.com/FreedomIntelligence/HuatuoGPT) ⭐ 1,320 | 🐛 3 | 🌐 Python | 📅 2024-12-16]
* \[2023/07] **MING: A Chinese Medical Consultation Large Model** *Yusheng Liao et al.* \[[code](https://github.com/MediaBrain-SJTU/MING) ⭐ 1,169 | 🐛 23 | 🌐 Python | 📅 2025-05-23]
* \[2023/03] **ChatGLM-Med** *Haochun Wang et al.* \[[code](https://github.com/SCIR-HI/Med-ChatGLM) ⭐ 1,038 | 🐛 31 | 🌐 Python | 📅 2023-05-19]
...
* \[2023/04] **BianQue: Balancing the Questioning and Suggestion Ability of Health LLMs with Multi-turn Health Conversations Polished by ChatGPT** *Yirong Chen et al. arXiv.* \[[paper](https://arxiv.org/abs/2310.15896)] \[[code](https://github.com/scutcyr/BianQue) ⭐ 884 | 🐛 22 | 🌐 Python | 📅 2023-10-25]
* \[2023/04] **DoctorGLM: Fine-tuning your Chinese Doctor is not a Herculean Task** *Honglin Xiong et al. arXiv.* \[[paper](https://arxiv.org/abs/2304.01097)] \[[code](https://github.com/xionghonglin/DoctorGLM) ⭐ 835 | 🐛 20 | 🌐 Python | 📅 2023-10-19]
* \[2023/05] **QiZhenGPT: An Open Source Chinese Medical Large Language Model** *Yao Chang et al.* \[[code](https://github.com/CMKRG/QiZhenGPT) ⭐ 774 | 🐛 8 | 🌐 Python | 📅 2024-08-09]
* \[2023/04] **PMC-LLaMA: Towards Building Open-source Language Models for Medicine** *Chaoyi Wu et al. arXiv.* \[[paper](https://arxiv.org/abs/2304.14454)] \[[code](https://github.com/chaoyi-wu/PMC-LLaMA) ⭐ 679 | 🐛 26 | 🌐 Python | 📅 2024-07-08]
* \[2023/04] **ChatMed: A Chinese Medical Large Language Model** *Wei Zhu et al.* \[[code](https://github.com/michael-wzhu/ChatMed) ⭐ 628 | 🐛 9 | 🌐 Python | 📅 2023-07-16]
...
* \[2023/04] **MedAlpaca--An Open-Source Collection of Medical Conversational AI Models and Training Data** *Tianyu Han et al. arXiv.* \[[paper](https://arxiv.org/abs/2304.08247)] \[[code](https://github.com/kbressem/medAlpaca) ⭐ 565 | 🐛 14 | 🌐 Python | 📅 2023-09-07]
* \[2023/05] **CMLM-ZhongJing: Large Language Model is Good Story Listener** *Yanlan Kang et al.* \[[code](https://github.com/pariskang/CMLM-ZhongJing) ⭐ 515 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-06-10]
* \[2023/06] **ShenNong-TCM: A Traditional Chinese Medicine Large Language Model** *Wei Zhu et al.* \[[code](https://github.com/michael-wzhu/ShenNong-TCM-LLM) ⭐ 504 | 🐛 7 | 🌐 Python | 📅 2023-08-31]
* \[2023/06] **PULSE** *OpenMedLab*. \[[code](https://github.com/openmedlab/PULSE) ⭐ 498 | 🐛 14 | 🌐 Python | 📅 2023-12-26]
* \[2023/06] **Sunsimiao: Chinese Medicine LLM** *Xin Yan et al.* \[[code](https://github.com/thomas-yanxin/Sunsimiao) ⭐ 468 | 🐛 6 | 🌐 Python | 📅 2024-09-13]
* \[2023/11] **HuatuoGPT-II, One-stage Training for Medical Adaption of LLMs** *Junying Chen et al. arXiv.* \[[paper](https://arxiv.org/abs/2311.09774)]\[[code](https://github.com/FreedomIntelligence/HuatuoGPT-II) ⭐ 411 | 🐛 31 | 🌐 Python | 📅 2024-08-30]
...
* \[2023/06] **TCMLLM** *Xuezhong Zhou et al.* \[[code](https://github.com/2020MEAI/TCMLLM) ⭐ 261 | 🐛 9 | 🌐 Python | 📅 2025-05-27]
* \[2023/11] **Taiyi: A Bilingual Fine-Tuned Large Language Model for Diverse Biomedical Tasks** *Ling Luo et al. arXiv.* \[[paper](https://arxiv.org/abs/2311.11608)]\[[code](https://github.com/DUTIR-BioNLP/Taiyi-LLM) ⭐ 168 | 🐛 0 | 🌐 Python | 📅 2025-07-28]
* \[2023/07] **HuangDi: A Generative Large Language Model for Ancient Chinese Medical Texts** *Jundong Zhang et al.* \[[code](https://github.com/Zlasejd/HuangDi) ⭐ 160 | 🐛 7 | 🌐 Python | 📅 2024-12-11]
* \[2022/12] **A large language model for electronic health records** *Xi Yang et al. npj Digital Medicine.* \[[paper](https://www.nature.com/articles/s41746-022-00742-2)] \[[code](https://github.com/uf-hobi-informatics-lab/GatorTron) ⭐ 138 | 🐛 5 | 🌐 Python | 📅 2023-11-03]
...
* \[2023/09] **MedChatZH: a Better Medical Adviser Learns from Better Instructions** *Tan et al. arXiv.* \[[paper](https://arxiv.org/abs/2309.01114)] \[[code](https://github.com/tyang816/MedChatZH) ⭐ 108 | 🐛 1 | 🌐 Python | 📅 2025-09-16]
* \[2023/10] **AlpaCare:Instruction-tuned Large Language Models for Medical Application** *Zhang et al. arXiv.* \[[paper](https://arxiv.org/abs/2310.14558)] \[[code](https://github.com/XZhang97666/AlpaCare) ⭐ 94 | 🐛 1 | 🌐 Python | 📅 2025-02-08]
* \[2023/05] **CAMEL: Clinically Adapted Model Enhanced from LLaMA** *Sunjun Kweon et al.* \[[code](https://github.com/starmpcc/CAMEL) ⭐ 89 | 🐛 0 | 🌐 Python | 📅 2023-09-01] \[[blog](https://starmpcc.github.io/CAMEL/)]
* \[2023/05] **Clinfo.AI: Answer Clinical Questions Grounded in Medical Literature** *Alejandro Lozano et al.* \[[code](https://github.com/som-shahlab/Clinfo.AI) ⭐ 37 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2024-08-20]
* \[2023/09] **HealGPT** *GR-Tech.* \[[code](https://github.com/TONYCHANBB/HealGPT) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2023-10-13] \[[demo](http://heal-gpt.cn/)]
...
* \[2023/06] **Lmflow: An extensible toolkit for finetuning and inference of large foundation models** *Shizhe Diao et al. arXiv.* \[[code](https://github.com/OptimalScale/LMFlow) ⭐ 8,484 | 🐛 87 | 🌐 Python | 📅 2026-08-10] \[[paper](https://arxiv.org/abs/2306.12420)] \[[blog](https://optimalscale.github.io/LMFlow/)]
* \[2023/06] **LLaVA-Med: Training a Large Language-and-Vision Assistant for Biomedicine in One Day** *Chunyuan Li et al. arXiv.* \[[paper](https://arxiv.org/abs/2306.00890)] \[[code](https://github.com/microsoft/LLaVA-Med/blob/main/README.md) ⭐ 2,228 | 🐛 107 | 🌐 Python | 📅 2025-06-04]
* \[2023/08] **BioMedGPT: Open Multimodal Generative Pre-trained Transformer for BioMedicine** *Yizhen Luo et al. arXiv.* \[[paper](https://arxiv.org/abs/2308.09442)] \[[code](https://github.com/PharMolix/OpenBioMed) ⭐ 1,101 | 🐛 38 | 🌐 Python | 📅 2026-07-22]
* \[2023/05] **XrayGLM: The first Chinese Medical Multimodal Model that Chest Radiographs Summarization** *Rongsheng Wang et al.* \[[code](https://github.com/WangRongsheng/XrayGLM) ⭐ 1,081 | 🐛 28 | 🌐 Python | 📅 2024-11-20]
* \[2023/05] **BiomedGPT: A Unified and Generalist Biomedical Generative Pre-trained Transformer for Vision, Language, and Multimodal Tasks** *Kai Zhang et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.17100)] \[[code](https://github.com/taokz/BiomedGPT) ⭐ 708 | 🐛 26 | 🌐 Python | 📅 2025-07-08]
* \[2023/08] **Towards Generalist Foundation Model for Radiology by Leveraging Web-scale 2D&3D Medical Data** *Chaoyi Wu et al. arXiv.* \[[paper](https://arxiv.org/abs/2308.02463)] \[[code](https://github.com/chaoyi-wu/RadFM) ⭐ 564 | 🐛 23 | 🌐 Python | 📅 2025-07-25]
* \[2023/06] **XrayGPT: Chest Radiographs Summarization using Medical Vision-Language Models** *Omkar Thawkar et al. arXiv.* \[[paper](https://arxiv.org/abs/2306.07971)] \[[code](https://github.com/mbzuai-oryx/XRayGPT) ⭐ 531 | 🐛 23 | 🌐 Python | 📅 2024-08-08]
* \[2023/07] **Med-Flamingo: a Multimodal Medical Few-shot Learner** *Michael Moor et al. arXiv.* \[[paper](https://arxiv.org/abs/2307.15189)] \[[code](https://github.com/snap-stanford/med-flamingo) ⭐ 454 | 🐛 19 | 🌐 Python | 📅 2023-08-23]
* \[2023/07] **Towards Generalist Biomedical AI** *Tao Tu et al. arXiv.* \[[paper](https://arxiv.org/abs/2307.14334)] \[[code](https://github.com/kyegomez/Med-PaLM) ⭐ 432 | 🐛 11 | 🌐 Python | 📅 2024-02-17]
* \[2023/04] **Visual Med-Alpaca: A Parameter-Efficient Biomedical LLM with Visual Capabilities** *Chang Shu et al.* \[[blog](https://cambridgeltl.github.io/visual-med-alpaca/)] \[[code](https://github.com/cambridgeltl/visual-med-alpaca) ⭐ 394 | 🐛 9 | 🌐 Python | 📅 2024-03-11]
* \[2023/05] **PMC-VQA: Visual Instruction Tuning for Medical Visual Question Answering** *Xiaoman Zhang et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.10415)] \[[code](https://github.com/xiaoman-zhang/PMC-VQA) ⭐ 237 | 🐛 16 | 🌐 Python | 📅 2024-12-06]
...
* \[2023/05] **PathAsst: Redefining Pathology through Generative Foundation AI Assistant for Pathology** *Yuxuan Sun et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.15072)] \[[code](https://github.com/superjamessyx/Generative-Foundation-AI-Assistant-for-Pathology) ⭐ 136 | 🐛 6 | 🌐 Python | 📅 2024-04-11]
* \[2023/10] **Qilin-Med-VL: Towards Chinese Large Vision-Language Model for General Healthcare** *Junling Liu et al. arXiv.* \[[paper](https://arxiv.org/abs/2310.17956)] \[[code](https://github.com/williamliujl/Qilin-Med-VL) ⭐ 65 | 🐛 7 | 🌐 Python | 📅 2023-12-01]
...
* \[2023/11] **MedAgents: Large Language Models as Collaborators for Zero-shot Medical Reasoning** *Tang et al. arXiv.* \[[paper](https://arxiv.org/abs/2311.10537)] \[[code](https://github.com/gersteinlab/MedAgents) ⭐ 364 | 🐛 0 | 🌐 Python | 📅 2024-05-27]
* \[2023/05] **ChatCAD+: Towards a Universal and Reliable Interactive CAD using LLMs** *Zihao Zhao et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.15964)] \[[code](https://github.com/zhaozh10/ChatCAD) ⭐ 197 | 🐛 4 | 🌐 Python | 📅 2024-11-23]
* \[2023/05] **PathAsst: Redefining Pathology through Generative Foundation AI Assistant for Pathology** *Yuxuan Sun et al. arXiv.* \[[paper](https://arxiv.org/abs/2305.15072)] \[[code](https://github.com/superjamessyx/Generative-Foundation-AI-Assistant-for-Pathology) ⭐ 136 | 🐛 6 | 🌐 Python | 📅 2024-04-11]
* \[2023/04] **ImpressionGPT: An Iterative Optimizing Framework for Radiology Report Summarization with ChatGPT** *Chong Ma et al. arXiv.* \[[paper](https://arxiv.org/abs/2304.08448)] \[[code](https://github.com/MoMarky/ImpressionGPT) ⭐ 21 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2024-03-20]
...
* \[2023/03] **G-Eval: NLG Evaluation using GPT-4 with Better Human Alignment** *Yang Liu et al. arXiv.* \[[paper](https://arxiv.org/abs/2303.16634)] \[[code](https://github.com/nlpyang/geval) ⭐ 431 | 🐛 9 | 🌐 Python | 📅 2024-02-04]
* \[2023/09] **Safetybench: Evaluating the safety of large language models with multiple choice questions.** *Zhexin Zhang et al. arXiv.* \[[paper](https://arxiv.org/abs/2309.07045)] \[[code](https://github.com/thu-coai/SafetyBench) ⭐ 297 | 🐛 1 | 🌐 Python | 📅 2025-07-28]
* \[2023/02] **GPTScore: Evaluate as You Desire** *Jinlan Fu et al. arXiv.* \[[paper](https://arxiv.org/abs/2302.04166)] \[[code](https://github.com/jinlanfu/GPTScore/blob/main/README.md) ⭐ 258 | 🐛 5 | 🌐 Python | 📅 2023-02-21]
* \[2023/07] **Med-HALT: Medical Domain Hallucination Test for Large Language Models.** *Ankit Pal et al. EMNLP'23.* \[[paper](https://arxiv.org/abs/2307.15343)] \[[code](https://github.com/medhalt/medhalt) ⭐ 34 | 🐛 3 | 🌐 Python | 📅 2026-03-07]
...
* \[2023/06] **A Survey on Multimodal Large Language Models.** *Shukang Yin et al. arXiv.* \[[paper](https://arxiv.org/abs/2306.13549)] \[[code](https://github.com/BradyFU/Awesome-Multimodal-Large-Language-Models) ⭐ 17,976 | 🐛 111 | 📅 2026-08-14]
* \[2023/03] **A survey of large language models.** *Wayne Xin Zhao et al. arXiv.* \[[paper](https://arxiv.org/abs/2303.18223)] \[[code](https://github.com/RUCAIBox/LLMSurvey) ⭐ 12,204 | 🐛 30 | 🌐 Python | 📅 2025-03-11]
* \[2023/09] **The Rise and Potential of Large Language Model Based Agents: A Survey.** *Zhiheng Xi et al. arXiv.* \[[paper](https://arxiv.org/abs/2309.07864)] \[[code](https://github.com/WooooDyy/LLM-Agent-Paper-List) ⭐ 8,171 | 🐛 31 | 📅 2025-09-12]
* \[2023/07] **A Survey on Evaluation of Large Language Models.** *Yupeng Chang et al. arXiv.* \[[paper](https://arxiv.org/abs/2307.03109)] \[[code](https://github.com/MLGroupJLU/LLM-eval-survey) ⭐ 1,611 | 🐛 6 | 📅 2026-08-01]
* \[2023/07] **Aligning Large Language Models with Human: A Survey.** *Yufei Wang et al. arXiv.* \[[paper](https://arxiv.org/abs/2307.12966)] \[[code](https://github.com/GaryYufei/AlignLLMHumanSurvey) ⭐ 742 | 🐛 0 | 📅 2023-09-11]
...
* [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,260 | 🐛 439 | 📅 2025-07-31
* [Awesome-Chinese-LLM](https://github.com/HqWu-HITCS/Awesome-Chinese-LLM) ⭐ 22,736 | 🐛 27 | 📅 2026-05-10
